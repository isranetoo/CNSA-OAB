...
def processar_arquivo():
    ...
    for arquivo in os.listdir(PASTA_ENTRADA):
        if arquivo.endswith(".json"):
            ...
            if not sociedades:
                print(f"Nenhuma sociedade encotrada no arquivo: {arquivo}")
                resultado = {
                    "erro": "Nenhuma sociedade encotrada",
                    "url": None
                }
            else:
                ...
                if url_parcial:
                    ...
                    print(f"URL não encotrada no arquivo: {arquivo}")
                    resultado = {
                        "erro": "URL não encotrada",
                        "url": None
                    }
